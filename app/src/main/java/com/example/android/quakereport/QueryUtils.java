...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractEarthquakes(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create an {@link List<Earthquake>}
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            //Get array with key features from root object
            JSONArray features = jsonRootObject.optJSONArray("features");

            //loop through array
            for(int i=0;i<features.length();i++){
                //get earthquake object at i position
                JSONObject earthquake = features.getJSONObject(i);

                //get propreties object
